...
export function App() {
  ...
  const metaScore =
    typeof selectedMovie?.Metascore === "string"
      ? parseInt(selectedMovie?.Metascore) || 0
      : undefined || 0;

  const rate =
    typeof selectedMovie?.imdbRating === "string"
      ? parseFloat(selectedMovie?.imdbRating) || 0
      : undefined || 0;

  const gross =
    typeof selectedMovie?.BoxOffice === "string"
      ? parseInt(selectedMovie.BoxOffice.replace(/[$,]/g, "")) || 0
      : undefined || 0;

  const vote =
    typeof selectedMovie?.imdbVotes === "string"
  ...
  const metaScore2 =
    typeof secondSelectedMovie?.Metascore === "string"
      ? parseInt(secondSelectedMovie?.Metascore) || 0
      : undefined || 0;
  
  const rate2 =
    typeof secondSelectedMovie?.imdbRating === "string"
      ? parseFloat(secondSelectedMovie?.imdbRating) || 0
      : undefined || 0;
  
  const gross2 =
    typeof secondSelectedMovie?.BoxOffice === "string"
      ? parseInt(secondSelectedMovie.BoxOffice.replace(/[$,]/g, "")) || 0
      : undefined || 0;
  
  const vote2 =
    typeof secondSelectedMovie?.imdbVotes === "string"
  ...
  const boxOffice =
    typeof gross !== "undefined" && typeof gross2 !== "undefined" && gross < gross2
      ? "red"
      : "green";
  const boxOffice2 =
    typeof gross !== "undefined" && typeof gross2 !== "undefined" && gross2 < gross
      ? "red"
      : "green";
  const awards =
    typeof sum !== "undefined" && typeof sum2 !== "undefined" && sum < sum2 ? "red" : "green";
  const awards2 =
    typeof sum !== "undefined" && typeof sum2 !== "undefined" && sum2 < sum ? "red" : "green";
  const votes =
    typeof vote !== "undefined" && typeof vote2 !== "undefined" && vote < vote2 ? "red" : "green";
  const votes2 =
    typeof vote !== "undefined" && typeof vote2 !== "undefined" && vote2 < vote ? "red" : "green";
  const score =
    typeof metaScore !== "undefined" && typeof metaScore2 !== "undefined" && metaScore < metaScore2
      ? "red"
      : "green";
  const score2 =
    typeof metaScore !== "undefined" && typeof metaScore2 !== "undefined" && metaScore2 < metaScore
      ? "red"
      : "green";
  const rating =
    typeof rate !== "undefined" && typeof rate2 !== "undefined" && rate < rate2 ? "red" : "green";
  const rating2 =
    typeof rate !== "undefined" && typeof rate2 !== "undefined" && rate2 < rate ? "red" : "green";
    ...
    <div>
      ...
      <div className={styles.contain}>
        ...
        <div
          ...
          <h1 className={styles.title2}>Search For a Movie on Both Sides</h1>
        ...
        <div className={styles.search}>
          <div className={styles.section}>
            ...
            />
            {searchTerm && <MovieDropDown movies={movies} onSelectMovie={handleSelectedMovie} />}
            <MovieDetails
              movie={selectedMovie}
              awards={awards}
              gross={boxOffice}
